    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Bagas Surahman")
